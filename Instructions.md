...
- Your login: is _SNCUST010
- The password is _SNCUST010
...
- Your userid is CUST010.
- Your password _MFCUST010.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS10 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS10 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST010.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST010.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
Username: _JENKINSCUST010
Password: Mfuser10@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-10.git`
