...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS10 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS10 --type LNK --os --maxrc 0 --sn 1 --cb`
...
`zowe jobs submit data-set "CUST010.MARBLES.JCL(MARBCOPY)" --vasc`
